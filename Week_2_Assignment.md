# 📘 Week 2 Assignment –  Advanced Interacting
...
---
**Requirements:**
1. Create object-pages: HomePage.ts, LoggedInPage.ts
2. Refactor existing test cases to use POM
3. Implement test-fixture: beforeEach, afterEach
4. Ensure updated test cases run & passed
...
**Requirements:**
1. Create object-pages: HomePage.ts, LoginForm.ts, AccountActivityPage, TransferFundsPage, TopHeaderPage with 3 parts: define Locators, init Locator, page methods
2. Refactor existing test cases to use POM
3. Implement test-fixture: beforeEach, afterEach
4. Ensure updated test cases run & passed
---
...
1. Create a new branch from `week2`  
2. Name your branch:
   ```
   week1_<yourname>
   ```
